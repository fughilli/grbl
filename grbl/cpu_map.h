...
#define cpu_map_h
  ...
  #define PROBE_MASK      (1<<PROBE_BIT)
    ...
    #define SPINDLE_PWM_MAX_VALUE     40 // Don't change. 328p fast PWM mode fixes top value as 255.
    #ifndef SPINDLE_PWM_MIN_VALUE
      #define SPINDLE_PWM_MIN_VALUE   14   // Must be greater than zero.
    #endif
    #define SPINDLE_PWM_OFF_VALUE     12
    ...
    #define SPINDLE_TCCRB_INIT_MASK      ((1<<CS22) | (1<<CS21) | (1<<CS20))              // 1/64 prescaler -> 0.98kHz (J-tech laser)
    ...
    // NOTE: Variable spindle not supported with this shield.
      ...
      #define STEP_DDR_DUAL       DDRC
      #define STEP_PORT_DUAL      PORTC
      #define DUAL_STEP_BIT       1  // Uno Analog Pin 1
      #define STEP_MASK_DUAL      ((1<<DUAL_STEP_BIT))
      #define DIRECTION_DDR_DUAL  DDRC
      #define DIRECTION_PORT_DUAL PORTC
      #define DUAL_DIRECTION_BIT  2  // Uno Analog Pin 2
      #define DIRECTION_MASK_DUAL ((1<<DUAL_DIRECTION_BIT))
      ...
      #endif
      #ifndef USE_SPINDLE_DIR_AS_ENABLE_PIN
        // Invert the logic level of the spindle direction pin. Uncomment to enable.
        //#define INVERT_SPINDLE_DIRECTION_PIN
        #define SPINDLE_DIRECTION_DDR   DDRB
        #define SPINDLE_DIRECTION_PORT  PORTB
        #define SPINDLE_DIRECTION_BIT   5  // Uno Digital Pin 13 (NOTE: D13 can't be pulled-high input due to LED.)
      #endif
